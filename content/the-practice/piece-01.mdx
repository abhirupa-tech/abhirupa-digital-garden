...
<Figure
  alt="A developer's AI and MCP server toolchain for production code"
  ratio="landscape"
/>
...
<Figure
  alt="Comparison of Cursor, Codex, Claude Code, and Gemini for coding tasks"
  ratio="landscape"
/>
...
<Figure
  alt="An LLM using MCP servers to act as an agent across tools"
  ratio="landscape"
/>
