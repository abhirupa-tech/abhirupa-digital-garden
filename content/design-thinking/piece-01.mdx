...
date: "2025-11-10"
cover: "https://miro.medium.com/v2/resize:fit:1400/1*G2a_kBjISoxsgCvdvL22Cg.png"
aspect: "wide"
draft: false
---

<Figure
  src="https://miro.medium.com/v2/resize:fit:1400/1*G2a_kBjISoxsgCvdvL22Cg.png"
  alt="A single confident chat response splintering into several plausible alternatives"
  caption="One answer was never the whole story — it was just the highest-probability guess."
  ratio="landscape"
/>

The current design paradigms to build user interfaces for LLM-powered products are no longer relevant — and here's why.

Stanford, in its most recent paper, discussed how typicality bias causes <Subnote note="When a model keeps returning the same few high-probability answers instead of the full range of valid ones.">mode collapse</Subnote> — resulting in very predictable responses from LLMs.
...
<Figure
  src="https://miro.medium.com/v2/resize:fit:1400/1*Dz3tw7sXV5Kpi7SkWJti2g.png"
...
<Figure
  src="https://miro.medium.com/v2/resize:fit:1400/1*Ap3mPUI07tdE63ep7WAmuA.png"
...
<Figure
  src="https://miro.medium.com/v2/resize:fit:1400/1*k7Ry0Ucn3FYCVekjSmvEkw.png"
...
<Figure
  src="https://miro.medium.com/v2/resize:fit:1400/1*li6GIgvZ2qoWbLFDLpWMrg.png"
...
<Figure
  src="https://miro.medium.com/v2/resize:fit:1400/1*joxp-le0nr7KXuqO6_7NgQ.png"
