...
date: "2026-04-16"
cover: "https://miro.medium.com/v2/resize:fit:1400/1*dkW8VWJLGwECegVihi01Mw.png"
aspect: "wide"
draft: false
---
...
Choosing the right <Subnote note="Large Language Model — an AI trained on massive amounts of text to predict and generate language.">LLM</Subnote> for your use case isn't optional anymore — it's strategic. I've worked extensively across the major models, and here's what I've learned about when to use what.
...
Because prompting is fundamentally just text prediction. When you prompt an LLM, you're asking it to generate the next likely <Subnote note="The unit an LLM reads and writes in — roughly a word-piece; usage and cost are counted in tokens.">token</Subnote> based on patterns it learned during training. It doesn't do anything — it just predicts what text should come next.
